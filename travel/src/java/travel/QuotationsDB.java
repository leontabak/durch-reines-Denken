...
public class QuotationsDB {
    ...
    public QuotationsDB() {
        ...
        String text = "Die Möglichkeit einer mechanischen "
                + "Erklärung der ganzen Natur ist "
                + "nicht bewiesen, ja, dass wir dieses Ziel "
                + "vollkommen erreichen werden,"
                + "kaum denkbar.";

        String name = "Ludwig Boltzmann";
        quotations.add(new Quotation(text, name));

        text = "Für den gläubigen Menschen steht Gott am Anfang, "
        ...
        text = "Die Wahrheit triumphiert nie, ihre Gegner "
                + "sterben nur aus.";

        name = "Max Planck";
        quotations.add(new Quotation(text, name));

        text = "Die Naturwissenschaft braucht "
        ...
        text = "Auch eine Enttäuschung, wenn sie "
        ...
        text = "Es hat Zeiten gegeben, in denen sich "
        ...
        text = "Religion und Naturwissenschaf---sie "
        ...
        text = "Ein rein verstandesmäßiges Weltbild ganz "
                + "ohne Mystik ist ein Unding.";

        name = "Erwin Schrödinger";
        quotations.add(new Quotation(text, name));

        text = "Ich gehöre zu der Generation, "
        ...
        text = "Ideen, wie absolute Gewißheit, absolute Genauigkeit, "
        ...
        text = "Das Wesen der Mathematik liegt in ihrer Freiheit.";

        name = "Georg Cantor";
        quotations.add(new Quotation(text, name));

        text = "In der Mathematik ist die Kunst, eine Frage zu stellen, "
                + "höher zu bewerten als die Kunst, sie zu lösen.";

        name = "Georg Cantor";
        quotations.add(new Quotation(text, name));

        text = "In der Mathematik gibt es kein Ignorabimus.";

        name = "David Hilbert";
        quotations.add(new Quotation(text, name));

        text = "Manche Menschen haben einen Gesichtskreis vom Radius Null "
                + "und nennen ihn ihren Standpunkt.";

        name = "David Hilbert";
        quotations.add(new Quotation(text, name));

        text = "Mathematik ist die Grundlage alles exakten "
                + "naturwissenschaftlichen Erkennens.";

        name = "David Hilbert";
        quotations.add(new Quotation(text, name));

        text = "Für einen Mathematiker haben Sie zu wenig Phantasie, "
                + "sie sollten Dichter werden.";

        name = "David Hilbert";
        quotations.add(new Quotation(text, name));

        text = "Im großen Garten der Geometrie kann sich jeder "
                + "nach seinem Geschmack einen Strauß pflücken.";

        name = "David Hilbert";
        quotations.add(new Quotation(text, name));

        text = "Wenn ich nach einem tausendjährigen "
        ...
        text = "Im Einzelnen möchte ich der Individualität "
                + "des Lehrers eine "
        ...
        text = "Die Logik ist die Hygiene, deren sich "
        ...
        text = "Die Symmetrie ist diejenige Idee, mit deren Hilfe "
                + "der Mensch im Laufe "
        ...
        text = "Die Ideen sind nicht verantwortlich für das, "
                + "was die Menschen aus ihnen machen.";

        name = "Werner Heisenberg";
        quotations.add(new Quotation(text, name));

        text = "Auch das lauteste Getöse großer "
        ...
        text = "Die Naturwissenschaft beschreibt "
        ...
        text = "Das Leben muss nicht leicht sein, "
                + "wenn es nur inhaltsreich ist.";

        name = "Lise Meitner";
        quotations.add(new Quotation(text, name));

        text = "Solange nur wir, die Verfolgten, "
        ...
        text = "In der Welt der Mathematik "
        ...
        text = "Das Schönste, was wir erleben können, "
                + "ist das Geheimnisvolle.";

        name = "Albert Einstein";
        quotations.add(new Quotation(text, name));

        text = "Die Naturwissenschaft ohne Religion ist lahm, "
                + "die Religion ohne Naturwissenschaft ist blind.";

        name = "Albert Einstein";
        quotations.add(new Quotation(text, name));

        text = "Gott würfelt nicht.";

        name = "Albert Einstein";
        quotations.add(new Quotation(text, name));

        text = "Raffiniert ist der Herrgot, "
                + "aber boshaft ist er nicht.";

        name = "Albert Einstein";
        quotations.add(new Quotation(text, name));

        text = "Thermodynamik ist ein komisches Fach. "
        ...
        text = "Was wir heutzutage aus der Sprache der Spektren "
        ...
        text = "Es handelt sich, so kurz wie möglich "
                + "ausgedrückt darum, "
        ...
        text = "Ohne Fehler kann es keine Brillanz geben.";

        name = "Emanuel Lasker";
        quotations.add(new Quotation(text, name));

        text = "Ich möchte Schüler heranbilden, "
        ...
        text = "Wenn Sie zu wählen haben zwischen einem Genie "
                + "und einem Charakter, "
        ...
        text = "Das Denken ist auch eine Wirklichkeit, "
                + "sogar eine der wichtigsten im Menschenleben.";

        name = "Wilhelm Ostwald";
        quotations.add(new Quotation(text, name));

        text = "Für augenblicklichen Gewinn verkaufe "
                + "ich die Zukunft nicht.";

        name = "Werner von Siemens";
        quotations.add(new Quotation(text, name));

        text = "Messen ist Wissen.";

        name = "Werner von Siemens";
        quotations.add(new Quotation(text, name));

        text = "Ohne Mathematik tappt man doch immer im Dunkeln.";

        name = "Werner von Siemens";
        quotations.add(new Quotation(text, name));

        text = "Es kommt nicht darauf an, mit dem Kopf "
        ...
        text = "Von 100 Genies gehen 99 unentdeckt zugrunde.";

        name = "Rudolf Diesel";
        quotations.add(new Quotation(text, name));

        text = "Jedes Naturgesetz, das sich dem Beobachter offenbart, "
                + "lässt auf ein höheres, noch unerkanntes schließen.";

        name = "Alexander von Humboldt";
        quotations.add(new Quotation(text, name));

        text = "Bei der Eroberung des Weltraums "
        ...
        text = "Wo viel Licht ist, ist starker Schatten.";

        name = "Johann Wolfgang von Goethe";
        quotations.add(new Quotation(text, name));

        text = "Auch für den Physiker ist "
        ...
        text = "Die Quantentheorie läßt keine völlig "
                + "objektive Beschreibung der Natur mehr zu.";

        name = "Werner Heisenberg";
        quotations.add(new Quotation(text, name));

        text = "Die Quantentheorie ist so ein wunderbares Beispiel dafür, "
        ...
        text = "Der Physiker erklärt die Geheimnisse der Natur nicht, "
                + "er führt sie auf tieferliegende Geheimnisse zurück.";

        name = "Carl Friedrich von Weizsäcker";
        quotations.add(new Quotation(text, name));

        text = "Ein Mathematiker, der nicht irgendwie ein Dichter ist, "
                + "wird nie ein vollkommener Mathematiker sein.";

        name = "Karl Weierstraß";
        quotations.add(new Quotation(text, name));

        text = "Wie die Musiker schon nach den ersten Akkorden Mozart, "
        ...
        text = "Was beweisbar ist, soll in der Wissenschaft "
                + "nicht ohne Beweis geglaubt werden.";

        name = "Richard Dedekind";
        quotations.add(new Quotation(text, name));

        text = "Es ist nicht das Wissen, sondern das Lernen, "
                + "nicht das Besitzen, "
        ...
        text = "Nichts ist getan, wenn noch "
                + "etwas zu tun übrig ist.";

        name = "Carl Friedrich Gauß";
        quotations.add(new Quotation(text, name));

        text = "Da ist das Problem, suche die Lösung. "
        ...
        text = "Die ganzen Zahlen hat der liebe Gott gemacht, "
                + "alles andere ist Menschenwerk.";

        name = "Leopold Kronecker";
        quotations.add(new Quotation(text, name));

        text = "Die Mathematik ist das Instrument, "
        ...
        text = "Man darf nicht das, was uns unwahrscheinlich "
        ...
        text = "Die Frage ist zu gut, um sie mit "
                + "einer Antwort zu verderben.";

        name = "Robert Koch";
        quotations.add(new Quotation(text, name));

        text = "Ich weiß, dass ich an der Geometrie "
